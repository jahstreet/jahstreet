...
- Platform Engineering @ [Adyen](https://github.com/Adyen)
- Data & ML @ [Miro](https://github.com/miroapp)
- Big Data Platforms @ [EPAM Systems](https://github.com/epam)
...
Portfolio:
- Improve connecting to Cassandra via ingress translator in a multi DC setup with Java driver: [#1](https://github.com/apache/cassandra-java-driver/pull/2007), [#2](https://github.com/apache/cassandra-java-driver/pull/2013)
